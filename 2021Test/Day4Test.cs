...
namespace _2021Test
{
    public class Day4Test : AdventOfCodeTest
    {
        public Day4Test(ITestOutputHelper output) : base(output)
        {
        }

        public class Part1 : Day4Test
        {
        ...
        public class Part2 : Day4Test
        {
            ...
            [Fact]
            public void Should_get_bingo_on_column()
            {
