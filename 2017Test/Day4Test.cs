...
namespace _2017Test
{
	public class Day4Test
	{
		...
		public void Example1()
		{
			...
			var result = target.CountValid(new[] {"aa bb cc dd ee"});
		...
		public void Example2()
		{
			...
			var result = target.CountValid(new[] {"aa bb cc dd aa"});
		...
		private string[] input = {"nyot babgr babgr kqtu kqtu kzshonp ylyk psqk",
